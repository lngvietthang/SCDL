...
if not MODEL_OUTPUT_FILE:
  MODEL_OUTPUT_FILE = "bidirection-1layer-earlystop-%s-%s-%s-%s.dat" % (ts, VOCABULARY_SIZE, EMBEDDING_DIM, HIDDEN_DIM)
...
#Print SGD step time
print 'Bidirection 1layer earlystop'
t1 = time.time()
...
write_output('./Output_bidirection_1layer_earlystop_theano', f1[5], original_sentence_text, compression_sentence_text, 0.6)
