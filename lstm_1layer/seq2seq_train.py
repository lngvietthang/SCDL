...
if not MODEL_OUTPUT_FILE:
  MODEL_OUTPUT_FILE = "GRU-1layer-%s-%s-%s-%s.dat" % (ts, VOCABULARY_SIZE, EMBEDDING_DIM, HIDDEN_DIM)
...
write_output('./Output_seq2seq_1layer_theano', f1[5], original_sentence_text, compression_sentence_text, 0.6)
