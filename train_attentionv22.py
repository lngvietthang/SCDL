...
from attentionv22_theano import GRUTheano
...
if not MODEL_OUTPUT_FILE:
  MODEL_OUTPUT_FILE = "AttentionV22-GRU-%s-%s-%s-%s.dat" % (ts, VOCABULARY_SIZE, EMBEDDING_DIM, HIDDEN_DIM)
...
write_output('./Output_attentionv22_theano', f1[5], original_sentence_text, compression_sentence_text, 0.6)
