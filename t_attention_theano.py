...
class GRUTheano:
    ...
    def __theano_build__(self):
        ...
        def forward_prop_step_decode_test(x_t, s_t1_matrix, s_t2_matrix, s_t3_matrix, o_t_pre_test,s_t1_prev_d_test, s_t2_prev_d_test, s_t3_prev_d_test, c_t1_prev_d_test, c_t2_prev_d_test, c_t3_prev_d_test):
            # This is how we calculated the hidden state in a simple RNN. No longer!
            # s_t = T.tanh(U[:,x_t] + W.dot(s_t1_prev))
